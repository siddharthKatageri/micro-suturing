...
MINOVERLAP = 0.1 # Set your IOU thresholde here
...
GT_PATH = os.path.join(os.getcwd(), 'input/', ground)
#DR_PATH = os.path.join(os.getcwd(), 'input', algo)
DR_PATH = os.path.join(os.getcwd(), 'input/', algo)
