...
def gmm_train(path, name):
    ...
    '''
    if(name=="knot"):
        k = 5       #actually chose k=5 for knot class by experimentation
    if(name=="nonknot"):
        k = 4
    gmm = GaussianMixture(n_components=k, covariance_type='full', max_iter=100, n_init=10, verbose=False).fit(final_features)
    #print("cov's are :\n", gmm.covariances_)
    #print("means are:\n", gmm.means_)
    #print("weights are:\n", gmm.weights_)
...
# this is to train gmm model
k_components, k_new_mean, k_new_sd, k_mus, k_covars, k_weights = gmm_train("E:\\CVG\\MicroSuture\\FINAL_DATASET\\train/knot_patches_extracted/", "knot")
nk_components, nk_new_mean, nk_new_sd, nk_mus, nk_covars, nk_weights = gmm_train("E:\\CVG\\MicroSuture\\FINAL_DATASET\\train/nonknot_patches_extracted", "nonknot")



# for saving the weights generated above
'''
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4k_components_1200.npy",k_components)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4k_new_mean_1200.npy",k_new_mean)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4k_new_sd_1200.npy",k_new_sd)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4k_mus_1200.npy",k_mus)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4k_covars_1200.npy",k_covars)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4k_weights_1200.npy", k_weights)

np.save("E:/CVG/MicroSuture/GMM/files/final_files/4nk_components_1200.npy",nk_components)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4nk_new_mean_1200.npy",nk_new_mean)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4nk_new_sd_1200.npy",nk_new_sd)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4nk_mus_1200.npy",nk_mus)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4nk_covars_1200.npy",nk_covars)
np.save("E:/CVG/MicroSuture/GMM/files/final_files/4nk_weights_1200.npy", nk_weights)
'''
